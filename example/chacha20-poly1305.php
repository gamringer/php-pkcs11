...
/*
$key = $session->generateKey(Pkcs11\CKM_CHACHA20_KEY_GEN, [
...
$iv = random_bytes(16);
$data = 'Hello World!';
$ciphertext = $key->encrypt(Pkcs11\CKM_CHACHA20_POLY1305, $data, $iv);
var_dump(bin2hex($ciphertext));

$plaintext = $key->decrypt(Pkcs11\CKM_CHACHA20_POLY1305, $ciphertext, $iv);
var_dump($plaintext);
*/
