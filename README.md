...
Given a symmetric key with AWS CloudHSM integration, the initial vector is generated by its library for you. A dedicated Parameters object is available:
...
$gcmParams = new Pkcs11\AwsGcmParams($aad, $tagLength);
