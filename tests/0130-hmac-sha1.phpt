...
if (!in_array(Pkcs11\CKM_SHA_1_HMAC, $module->getMechanismList((int)getenv('PHP11_SLOT')))) {
...
$key = $session->createObject([
	...
	Pkcs11\CKA_VALUE => str_repeat(chr(0), 20),
	Pkcs11\CKA_PRIVATE => true,
	Pkcs11\CKA_SIGN => true,
]);

$data = "Hello World!";
$mac = $key->sign(new Pkcs11\Mechanism(Pkcs11\CKM_SHA_1_HMAC), $data);
