...
PHP_MINIT_FUNCTION(pkcs11)
{
    ...
    REGISTER_PKCS11_CONSTANT(CKN_SURRENDER);
    REGISTER_PKCS11_CONSTANT(CKN_OTP_CHANGED);

    // Yubico Vendor Definitions
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKM_YUBICO_AES_CCM_WRAP",    CKR_VENDOR_DEFINED | 0x59554204UL, CONST_CS | CONST_PERSISTENT);
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKK_YUBICO_AES128_CCM_WRAP", CKR_VENDOR_DEFINED | 0x5955421dUL, CONST_CS | CONST_PERSISTENT);
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKK_YUBICO_AES192_CCM_WRAP", CKR_VENDOR_DEFINED | 0x59554229UL, CONST_CS | CONST_PERSISTENT);
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKK_YUBICO_AES256_CCM_WRAP", CKR_VENDOR_DEFINED | 0x5955422aUL, CONST_CS | CONST_PERSISTENT);
