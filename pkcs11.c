...
PHP_MINIT_FUNCTION(pkcs11)
{
    ...
    REGISTER_PKCS11_CONSTANT(CKF_TOKEN_PRESENT);
    REGISTER_PKCS11_CONSTANT(CKF_REMOVABLE_DEVICE);
    REGISTER_PKCS11_CONSTANT(CKF_HW_SLOT);
    ...
    REGISTER_PKCS11_CONSTANT(CKF_ARRAY_ATTRIBUTE);
    REGISTER_PKCS11_CONSTANT(CKF_HW);
    REGISTER_PKCS11_CONSTANT(CKF_MESSAGE_ENCRYPT);
    REGISTER_PKCS11_CONSTANT(CKF_MESSAGE_DECRYPT);
    REGISTER_PKCS11_CONSTANT(CKF_MESSAGE_SIGN);
    REGISTER_PKCS11_CONSTANT(CKF_MESSAGE_VERIFY);
    REGISTER_PKCS11_CONSTANT(CKF_MULTI_MESSAGE);
    REGISTER_PKCS11_CONSTANT(CKF_MULTI_MESSGE);
    REGISTER_PKCS11_CONSTANT(CKF_FIND_OBJECTS);
    ...
    REGISTER_PKCS11_CONSTANT(CKF_EC_F_P);
    REGISTER_PKCS11_CONSTANT(CKF_EC_F_2M);
    REGISTER_PKCS11_CONSTANT(CKF_EC_ECPARAMETERS);
    REGISTER_PKCS11_CONSTANT(CKF_EC_OID);
    REGISTER_PKCS11_CONSTANT(CKF_EC_NAMEDCURVE);
    REGISTER_PKCS11_CONSTANT(CKF_EC_UNCOMPRESS);
    REGISTER_PKCS11_CONSTANT(CKF_EC_COMPRESS);
    REGISTER_PKCS11_CONSTANT(CKF_EC_CURVENAME);
    REGISTER_PKCS11_CONSTANT(CKF_EXTENSION);
    REGISTER_PKCS11_CONSTANT(CKF_END_OF_MESSAGE);
    REGISTER_PKCS11_CONSTANT(CKF_INTERFACE_FORK_SAFE);
    ...
    REGISTER_PKCS11_CONSTANT(CKF_NEXT_OTP);
    REGISTER_PKCS11_CONSTANT(CKF_EXCLUDE_TIME);
    REGISTER_PKCS11_CONSTANT(CKF_EXCLUDE_COUNTER);
    REGISTER_PKCS11_CONSTANT(CKF_EXCLUDE_CHALLENGE);
    REGISTER_PKCS11_CONSTANT(CKF_EXCLUDE_PIN);
    REGISTER_PKCS11_CONSTANT(CKF_USER_FRIENDLY_OTP);
    REGISTER_PKCS11_CONSTANT(CKF_HKDF_SALT_NULL);
    REGISTER_PKCS11_CONSTANT(CKF_HKDF_SALT_DATA);
    REGISTER_PKCS11_CONSTANT(CKF_HKDF_SALT_KEY);
    ...
    // Yubico Vendor Definitions
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKM_YUBICO_AES_CCM_WRAP",    CKM_VENDOR_DEFINED | 0x59554204UL, CONST_CS | CONST_PERSISTENT);
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKK_YUBICO_AES128_CCM_WRAP", CKM_VENDOR_DEFINED | 0x5955421dUL, CONST_CS | CONST_PERSISTENT);
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKK_YUBICO_AES192_CCM_WRAP", CKM_VENDOR_DEFINED | 0x59554229UL, CONST_CS | CONST_PERSISTENT);
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKK_YUBICO_AES256_CCM_WRAP", CKM_VENDOR_DEFINED | 0x5955422aUL, CONST_CS | CONST_PERSISTENT);

    // AWS CloudHSM Vendor Definitions
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKM_CLOUDHSM_AES_GCM",                 CKM_VENDOR_DEFINED | CKM_AES_GCM, CONST_CS | CONST_PERSISTENT);
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKM_CLOUDHSM_AES_KEY_WRAP_NO_PAD",     CKM_VENDOR_DEFINED | CKM_AES_KEY_WRAP, CONST_CS | CONST_PERSISTENT);
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKM_CLOUDHSM_AES_KEY_WRAP_PKCS5_PAD",  CKM_VENDOR_DEFINED | CKM_AES_KEY_WRAP_PAD, CONST_CS | CONST_PERSISTENT);
    REGISTER_NS_LONG_CONSTANT("Pkcs11", "CKM_CLOUDHSM_AES_KEY_WRAP_ZERO_PAD",   CKM_VENDOR_DEFINED | 0x0000216FUL, CONST_CS | CONST_PERSISTENT);
