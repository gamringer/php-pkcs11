...
if test "$PHP_PKCS11" != "no"; then
  ...
  PHP_NEW_EXTENSION(pkcs11, pkcs11.c pkcs11key.c pkcs11keypair.c pkcs11module.c pkcs11rsapssparams.c pkcs11rsaoaepparams.c pkcs11gcmparams.c pkcs11ecdh1deriveparams.c pkcs11session.c, $ext_shared)
fi
